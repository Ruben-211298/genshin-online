...
def full_5star_wishing(wishes, total_tries, currently_pitty, fifty_origin, Number_of_5stars, order):
    ...
    #Parameters
    prob_char_nonpitty = 0.008
    nonpitty_char_duration = 66
    prob_char_pitty = 0.06
    pitty_char_duration = 80
    #prob_char_80 = 1

    prob_wpn_nonpitty = 0.008
    ...
    for m in range(total_tries):
        ...
        pitty_character = currently_pitty[0]
        pitty_weapon = currently_pitty[1]
        char_got = False
        wpn_got = False
        bargain_coins = 0.0
            ...
            if tries > 0:
                if element == 'character':
                    ...
                    while promotional_characters != pre_promotional_characters+1 and tries > 0:
                        ...
                        # Subpitty
                        if gold == False and tries > 0:
                            for t in range(nonpitty_char_duration+1, pitty_char_duration):
                                luck = random()
                                tries = tries - 1
                    ...
                    while promotional_weapons != pre_promotional_weapons+1 and tries > 0:
                        ...
                        # Subpitty
                        if gold == False and tries > 0:
                            for t in range(nonpitty_wpn_duration+1, pitty_wpn_duration):
                                luck = random()
                                tries = tries - 1
                        ...
                        if gold == True:
                            ...
                            #     if luck_50 < 0.750000 or epitomized == 1:
                            #         fifty_weapon = True
        ...
        bargain_all.append(bargain_coins)
    
    bargain_final = sum(bargain_all) / len(bargain_all)

    return dens_prob_Promotional_order, bargain_final
